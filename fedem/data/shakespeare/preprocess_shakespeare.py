...
def _get_train_test_by_character(plays, test_fraction=0.2, thres_n_lines=2):
    """
    ...
    for play, characters in plays:
        ...
        for character, sound_bites in characters.items():
            ...
            if len(examples) <= thres_n_lines:
                skipped_characters += 1
                # Skip characters with fewer than some lines since we need at least one
